document.addEventListener('DOMContentLoaded', () =>{ 
 ...
 form.addEventListener('submit', (event) =>{
    ...
    const url = `https://wt-eea20b749793fa73fffb24558f3360b6-0.run.webtask.io/prueba-esquema`;
    ...
    .then(function (data) {  
        ...
        form.reset();
        toggleMessage('Mensaje enviado con éxito, pronto estaremos en contacto');
    })  
